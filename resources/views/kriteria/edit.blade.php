    ...
    <div class="row" style="padding-left: 0 5px 0 5px">
        <div class="col-lg-5">
            {{-- menampilkan error validasi --}}
                            ...
                            @endif
                     <form method="POST" action="{{ route('kriteria.update', $datas->id_kriteria)}}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                                    {{ method_field('PUT') }}
                                        {{ csrf_field() }}
                            @include ('kriteria.form', ['formMode' => 'edit'])
        </form>
        </div>
